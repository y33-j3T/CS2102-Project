...
CALL book_room (2, 3, '2021-11-01', 10, 14, 33);

-- CALL join_meeting (2, 3, '2021-11-01', 10, 14, 50);
CALL join_meeting (2, 3, '2021-11-01', 10, 14, 48);
CALL join_meeting (2, 3, '2021-11-01', 10, 14, 47);
CALL join_meeting (2, 3, '2021-11-01', 10, 14, 46);
--CALL join_meeting (2, 3, '2021-11-01', 10, 14, 45);
CALL join_meeting (2, 3, '2021-11-01', 10, 14, 1);

CALL approve_meeting (2, 3, '2021-11-01', 10, 14, 2);
...
-- declare_health test
CALL declare_health(1, '2021-10-31', 36.0); -- successful, non-fever
...
CALL declare_health(2, '2021-10-31', 36.3);
CALL declare_health(2, '2021-11-01', 35.9);
CALL declare_health(3, '2021-11-01', 35.7);
CALL declare_health(4, '2021-10-31', 37.0);


SELECT * FROM HealthDeclaration WHERE date >= CURRENT_DATE;
...
-- CALL unbook_room (2, 3, '2021-11-01', 10, 14, 33);
