...
CALL book_room (2, 3, '2021-11-06', 10, 14, 33);

-- CALL join_meeting (2, 3, '2021-11-01', 10, 14, 50);
CALL join_meeting (2, 3, '2021-11-06', 10, 14, 48);
CALL join_meeting (2, 3, '2021-11-06', 10, 14, 47);
CALL join_meeting (2, 3, '2021-11-06', 10, 14, 46);
--CALL join_meeting (2, 3, '2021-11-01', 10, 14, 45);
CALL join_meeting (2, 3, '2021-11-06', 10, 14, 1);

CALL approve_meeting (2, 3, '2021-11-06', 10, 14, 2);
...
-- declare_health test
CALL declare_health(1, '2021-11-05', 36.0); -- successful, non-fever
--CALL declare_health(1, '2021-10-29', 36.1); -- unsuccessful, violates key constraints
CALL declare_health(1, '2021-11-06', 38); -- successful, fever
--CALL declare_health(1, '2021-11-05', 47); -- unsuccessful, violates defined constraints
--CALL declare_health(1, '2021-11-05', 30); -- unsuccessful, violates defined constraints
CALL declare_health(2, '2021-11-05', 36.3);
CALL declare_health(2, '2021-11-06', 35.9);
CALL declare_health(3, '2021-11-05', 35.7);
CALL declare_health(4, '2021-11-05', 37.0);
...
CALL unbook_room (2, 3, '2021-11-06', 10, 14, 33);
